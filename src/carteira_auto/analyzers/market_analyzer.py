...
class MarketAnalyzer(Node):
    ...
    def run(self, ctx: PipelineContext) -> PipelineContext:
        metrics = self._fetch_benchmarks()
    ...
    def _fetch_benchmarks(self) -> MarketMetrics:
        ...
        try:
            ...
            logger.warning(f"Falha ao buscar IBOV: {e}")
        ...
        try:
            ...
            logger.warning(f"Falha ao buscar IFIX: {e}")
