...
- **Mapa do código**: `docs/ARCHITECTURE.md`
...
- **Padrões de código**: `docs/PATTERNS.md`
  ...
  models e publishers. Siga o pattern correspondente ao criar componentes.
...
- **Grafo de dependências**: `docs/DEPENDENCY_GRAPH.mermaid`
...
Use estes comandos para workflows recorrentes:

- `/project:new-fetcher <fonte>` — Cria fetcher seguindo docs/PATTERNS.md
- `/project:new-analyzer <domínio>` — Cria analyzer como Node DAG
- `/project:new-strategy <nome>` — Cria strategy com evaluate() → StrategyResult
- `/project:sprint-review` — Revisão estruturada do sprint atual
- `/project:audit-phase <N>` — Audita o estado do repo para a fase N
